...
import com.warehousemanagement.models.*;
import com.warehousemanagement.services.*;
...
import static com.warehousemanagement.models.enums.OrderStatusEnum.*;
...
public class OrderController {
    ...
    @DeleteMapping("/order/remove/item/{id}")
    ...
    @PostMapping("/order/submit/{orderNumber}")
    ...
    @DeleteMapping("/order/cancel/{orderNumber}")
    ...
    @GetMapping("/order/client/filter")
    ...
    @PostMapping("/order/approve/{orderNumber}")
    ...
    @PostMapping("/order/decline/{orderNumber}")
    ...
    @PostMapping("/order/fulfill/{orderNumber}")
